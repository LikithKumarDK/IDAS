...
var api = new ParseServer({
  databaseURI: "mongodb://localhost:27017/idas", // Connection string for your MongoDB database
  cloud: "./cloud/admin-main.js", // Absolute path to your Cloud Code
  appId: "idasApp",
  masterKey: "oZW03OlqZC", // Keep this key secret!
  fileKey: "oZW03OlqZC",
  publicServerURL:"http://192.168.1.205:1336/api/v1",
  serverURL: "http://192.168.1.205:1336/api/v1", // Don't forget to change to https if needed
...
var dashboard = new ParseDashboard({
  ...
  apps: [
    {
      serverURL: "http://192.168.1.205:1336/api/v1",
      appId: "idasApp",
...
app.listen(1336, function() {
  console.log("parse-server-example running on port 1336.");
});
