...
var api = new ParseServer({
  ...
  fileKey: "oZW03OlqZC",
  publicServerURL:"http://stg-idas.itohen.pro:1337/api/v1",
  serverURL: "http://stg-idas.itohen.pro:1337/api/v1", // Don't forget to change to https if needed
...
var dashboard = new ParseDashboard({
  ...
  apps: [
    {
      serverURL: "http://stg-idas.itohen.pro:1337/api/v1",
      appId: "idasApp",
